...
open class PirateChainPaymentURI: PirateChainPaymentURIProtocol {
    ...
    fileprivate var allParameters: [String: ARRRParameter]?
    ...
    open var amount: Double? {
        set(newValue) {
            ...
            self.allParameters?[PirateChainPaymentURI.PARAMETER_AMOUNT] = ARRRParameter(value: String(newValue), required: false)
        }
    ...
    open var label: String? {
        set(newValue) {
            ...
            self.allParameters?[PirateChainPaymentURI.PARAMETER_LABEL] = ARRRParameter(value: newValue, required: false)
        }
    ...
    open var message: String? {
        set(newValue) {
            ...
            self.allParameters?[PirateChainPaymentURI.PARAMETER_MESSAGE] = ARRRParameter(value: newValue, required: false)
        }
    ...
    /// The parameters.
    open var parameters: [String: ARRRParameter]? {
        set(newValue) {
            var newParameters: [String: ARRRParameter] = [:]
        ...
        return PirateChainPaymentURI(build: {
            ...
            if urlComponents.count > 0 {
                for queryItem in urlComponents {
                    ...
                    newParameters[queryItem.name.replacingOccurrences(of: PARAMETER_REQUIRED_PREFIX, with: "")] = ARRRParameter(value: value, required: required)
                }
            }
